...
def init_pix_routes(app):
    ...
    def form_bancario_enviar():
        ...
        # Validar entregador
        cursor.execute("""
            SELECT id_da_pessoa_entregadora, recebedor, cnpj
            FROM entregadores
        ...
        return render_template(TEMPLATES_PIX['form_public'], modal={
            "type": "sucesso",
            "nome": nome or entregador["recebedor"]
        })
